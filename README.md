...
- [Основы F#](#основы-f-1)
- [Функции и их применение](#функции-и-их-применение-2)
    + [Отличие fun от function](#fun-vs-function)
    + [Рекурсия](#рекурсия)
- [Списки, алгебраические типы](#списки-алгебраические-типы-3)
    + [Функции для списков](#некоторые-функции-списков)
    + [Примеры применения списков](#немного-примеров)
- [Различные структуры](#различные-структуры-4)
    + [Дерево общего вида](#дерево-общего-вида)
    + [Очереди](#очереди)
    + [Zippers](#zippers)
- [Приёмы функционального программирования](#приёмы-функционального-программирования-5)
    + [Замыкания](#замыкания)
    + [Генераторы](#генераторы)
    + [Последовательности](#последовательности)
    + [Продолжения](#продолжения)
- [Монады и монадические выражения, теория категорий](#монады-и-монадические-выражения-6)
    + [Примеры монад](#сперва-примеры)
    + [Определение монад](#определение-монад)
    + [Монадические законы](#монадические-законы)
    + [Монадические выражения](#монадические-выражения)
    + [Теория категорий](#теория-категорий-типизация-и-функциональное-программирование)
        - [Категории](#категории)
        - [Функторы](#функторы)
